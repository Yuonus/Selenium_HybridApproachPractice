...
//		}
		// when if conditions are having one line (no else block) then you can write them in one line.
		...
		// Added for mvn clean install
//		if(Boolean.parseBoolean(System.getProperty("headless", prop.getProperty("headless")).trim())) 
//			co.addArguments("--headless");
//
//		if(Boolean.parseBoolean(System.getProperty("incognito", prop.getProperty("incognito")).trim())) 
//			co.addArguments("--incognito");
